...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="inicioSistema">
        <div class="sidebar-brand-icon rotate-n-15">
            <i class="fas fa-laugh-wink"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Dividas</div>
    </a>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="inicioSistema">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Analise de Dividas:</h6>
    ...
    <div class="sidebar-card">
        <img class="sidebar-card-illustration mb-2" src="<%=request.getContextPath()%>/resources/template/img/undraw_rocket.svg" alt="">
